...
public class UserDAO {
    ...
    public boolean addUser(String username, String password, String email) {
        ...
        DBObject doc = new BasicDBObject().append("_id", username).append("password", passwordHash).append("email", email);
    ...
    public DBObject validateLogin(String username, String password) {
        ...
        // SEA look in the user collection for a user that has this username
